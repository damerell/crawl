...
void monster::timeout_enchantments(int levels)
{
    ...
    for (auto &entry : ec)
    {
        ...
        case ENCH_FEAR_INSPIRING: case ENCH_REGENERATION: case ENCH_TROGS_HAND:
        ...
        case ENCH_CORROSION: case ENCH_GOLD_LUST:
        ...
        case ENCH_WHIRLWIND_PINNED: case ENCH_WU_TOHIT: 
