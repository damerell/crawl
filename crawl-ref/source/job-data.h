...
{ JOB_ABYSSAL_KNIGHT, {
    "AK", "Abyssal Knight",
    4, 4, 4,
    { SP_HILL_ORC, SP_TROLL, SP_MERFOLK, SP_FORMICID, SP_DEMONSPAWN, },
    { "leather armour" },
    WCHOICE_PLAIN,
...
{ JOB_AIR_ELEMENTALIST, {
    "AE", "Air Elementalist",
    0, 7, 5,
    { SP_HIGH_ELF, SP_DEEP_ELF, SP_TENGU, SP_FAERIE_DRAGON, SP_BARACHI },
    { "robe", "book of Air" },
    WCHOICE_NONE,
...
{ JOB_ARCANE_MARKSMAN, {
    "AM", "Arcane Marksman",
    2, 5, 5,
    { SP_HIGH_ELF, SP_DEEP_ELF, SP_KOBOLD, SP_SPRIGGAN,
      SP_CENTAUR, SP_FORMICID },
...
{ JOB_ARTIFICER, {
    "Ar", "Artificer",
    4, 3, 5,
    { SP_DEEP_DWARF, SP_KOBOLD, SP_SPRIGGAN, SP_OCTOPODE,
      SP_FORMICID, SP_MOUNTAIN_DWARF },
    { "short sword", "leather armour", "wand of flame charges:15",
      "wand of charm monster charges:15", 
...
{ JOB_ASSASSIN, {
    "As", "Assassin",
    3, 3, 6,
    { SP_MERFOLK, SP_HALFLING, SP_SPRIGGAN, SP_SLUDGE_ELF, SP_VAMPIRE,
      SP_VINE_STALKER, },
...
{ JOB_BERSERKER, {
	...
	SP_DEMONSPAWN, SP_MOUNTAIN_DWARF, SP_BARACHI, SP_VINE_STALKER },
    { "animal skin" },
    WCHOICE_PLAIN,
...
{ JOB_CHAOS_KNIGHT, {
    "CK", "Chaos Knight",
    4, 4, 4,
    { SP_GNOLL, SP_HUMAN, SP_BARACHI, SP_DEMONSPAWN },
...
{ JOB_FIGHTER, {
    ...
    { SP_DEEP_DWARF, SP_HILL_ORC, SP_TROLL, SP_MINOTAUR, SP_GARGOYLE,
      SP_CENTAUR, SP_MOUNTAIN_DWARF, SP_FORMICID },
    { "scale armour", "kite shield", "potion of might" },
    WCHOICE_GOOD,
...
{ JOB_FIRE_ELEMENTALIST, {
    ...
    0, 7, 5,
    { SP_DEEP_ELF, SP_HILL_ORC, SP_TENGU, SP_DEMIGOD,
...
{ JOB_GLADIATOR, {
    "Gl", "Gladiator",
    6, 0, 6,
    { SP_BARACHI, SP_HILL_ORC, SP_MERFOLK, SP_MINOTAUR, SP_GARGOYLE,
      SP_CENTAUR, },
...
{ JOB_ICE_ELEMENTALIST, {
    "IE", "Ice Elementalist",
    0, 7, 5,
    { SP_DEEP_ELF, SP_MERFOLK, SP_BARACHI, SP_GARGOYLE, SP_FAERIE_DRAGON },
    { "robe", "book of Frost" },
    WCHOICE_NONE,
...
{ JOB_MONK, {
    ...
    { SP_DEEP_DWARF, SP_HILL_ORC, SP_TROLL, SP_CENTAUR, SP_MERFOLK,
      SP_GARGOYLE, SP_DEMONSPAWN, SP_FORMICID },
    { "robe" },
    WCHOICE_PLAIN,
...
{ JOB_NECROMANCER, {
    ...
    { "short sword", "robe", "book of Necromancy" },
    WCHOICE_NONE,
...
{ JOB_SKALD, {
    "Sk", "Skald",
    3, 5, 4,
    { SP_HIGH_ELF, SP_HALFLING, SP_MERFOLK, SP_VAMPIRE, SP_BARACHI },
...
{ JOB_SUMMONER, {
    "Su", "Summoner",
    0, 7, 5,
    { SP_DEEP_ELF, SP_HILL_ORC, SP_FELID, SP_MERFOLK, SP_TENGU,
      SP_VAMPIRE },
...
{ JOB_VENOM_MAGE, {
    "VM", "Venom Mage",
    0, 7, 5,
    { SP_DEEP_ELF, SP_SPRIGGAN, SP_NAGA, SP_MERFOLK, SP_TENGU, SP_FORMICID,
      SP_DEMONSPAWN, SP_FAERIE_DRAGON },
    { "short sword", "robe", "Young Poisoner's Handbook" },
    WCHOICE_NONE,
...
{ JOB_WANDERER, {
    "Wn", "Wanderer",
    0, 0, 0, // Randomised
    { SP_HILL_ORC, SP_SPRIGGAN, SP_OCTOPODE, SP_MERFOLK, SP_BASE_DRACONIAN,
...
{ JOB_WARPER, {
    "Wr", "Warper",
    3, 5, 4,
	{ SP_HALFLING, SP_HIGH_ELF, SP_SPRIGGAN, SP_FELID, SP_DEEP_ELF },
