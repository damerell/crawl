...
// carnivorous quadrupeds ('h')
{
    ...
    1, 55,
    2, 13, MST_NO_SPELLS, CE_CLEAN, S_SQUEAK,
    I_ANIMAL, HT_LAND, 12, DEFAULT_ENERGY,
...

{
    ...
    4, 55,
    5, 13, MST_NO_SPELLS, CE_NOCORPSE, S_BARK,
    I_ANIMAL, HT_LAND, 13, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_QUADRUPED,
...

{
    ...
    M_NO_ZOMBIE,
    MR_RES_COLD,
    10, MONS_GHOUL, MONS_ROTTING_HULK, MH_UNDEAD, 60,
	{ { AT_HIT, AF_DISEASE, 34 }, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    11, 825,
    5, 7, MST_NO_SPELLS, CE_NOXIOUS, S_SILENT,
    I_HUMAN, HT_LAND, 9, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_HUMANOID,
	{ TILEP_MONS_ROTTING_HULK}, TILE_CORPSE_ROTTING_HULK
				    },
...
{
    MONS_CAVALIER, 'p', LIGHTCYAN, "cavalier",
    M_WARM_BLOOD | M_FIGHTER | M_TWO_WEAPONS | M_SPEAKS,
    MR_NO_FLAGS,
    10, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, 100,
    { {AT_HIT, AF_PLAIN, 25}, {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK },
    12, 750,
    4, 15, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, ATTACK_ENERGY(8),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_CAVALIER}, TILE_ERROR
},
...
// rodents ('r')
{
    ...
    { {AT_BITE, AF_PLAIN, 3}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 25,
    1, 10, MST_NO_SPELLS, CE_CLEAN, S_SQUEAK,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_TINY, MON_SHAPE_QUADRUPED,
...

{
    ...
    2, 110,
    5, 11, MST_NO_SPELLS, CE_NOXIOUS, S_SQUEAK,
    I_ANIMAL, HT_AMPHIBIOUS, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_TINY, MON_SHAPE_QUADRUPED,
...

{
    ...
    { {AT_TAIL_SLAP, AF_PLAIN, 15}, {AT_BITE, AF_DRAG, 30}, AT_NO_ATK,
       AT_NO_ATK },
    12, 720,
...
{
    MONS_BUMBLEBEE, 'y', YELLOW, "bumblebee",
    M_NO_SKELETON | M_FLIES,
    MR_VUL_POISON,
    10, MONS_KILLER_BEE, MONS_BUMBLEBEE, MH_NATURAL, 20,
    { {AT_STING, AF_POISON, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 385,
    4, 15, MST_NO_SPELLS, CE_NOXIOUS, S_BUZZ,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_TINY, MON_SHAPE_INSECT_WINGED,
    {TILEP_MONS_BUMBLEBEE}, TILE_CORPSE_BUMBLEBEE
},
...

{
    ...
    M_NO_SKELETON | M_NO_ZOMBIE | M_BLOOD_SCENT | M_FLIES,
    MR_NO_FLAGS,
...
{
    MONS_FIREFLY, 'y', LIGHTBLUE, "firefly",
    M_NO_SKELETON | M_FLIES,
    MR_VUL_POISON | MR_RES_FIRE,
    10, MONS_FIREFLY, MONS_FIREFLY, MH_NATURAL, 50,
	{ {AT_BITE, AF_FIRE, 17}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 315,
    1, 18, MST_FIREFLY, CE_NOXIOUS, S_SILENT,
    I_ANIMAL, HT_LAND, 16, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_TINY, MON_SHAPE_INSECT_WINGED,
	{TILEP_MONS_FIREFLY}, TILE_CORPSE_FIREFLY
},
...

{
    ...
    { {AT_HIT, AF_STICKY_FLAME, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    8, 440,
    12, 13, MST_NO_SPELLS, CE_NOCORPSE, S_SCREAM,
    I_ANIMAL, HT_LAND, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_FLAMING_CORPSE, TVARY_WATER}, TILE_ERROR
},
...

{
    ...
    M_NO_SKELETON | M_NO_ZOMBIE | M_BATTY,
    MR_NO_FLAGS,
...
// This is to make the tainted leviathan commit not apply cleanly
// so I can then make them M_NO_ZOMBIE as done in vanilla commit
// 6f9dbf35b3c7c702fc83add78e1c437972a7bce4
DUMMY(MONS_TAINTED_LEVIATHAN, 'C', GREEN, "tainted leviathan", TILEP_MONS_STONE_GIANT)
    
{
    ...
    1, 2, MST_NO_SPELLS, CE_NOXIOUS, S_SILENT,
    I_HUMAN, HT_LAND, 10, ATTACK_ENERGY(20),
    MONUSE_STARTING_EQUIPMENT, SIZE_GIANT, MON_SHAPE_HUMANOID,
...

{
    ...
    I_BRAINLESS, HT_WATER, 8, MOVE_ENERGY(16),
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_PLANT,
...

{
    ...
    M_COLD_BLOOD,
    MR_RES_POISON,
    10, MONS_SNAKE, MONS_VIPER, MH_NATURAL, 20,
    { {AT_BITE, AF_POISON, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 330,
    4, 14, MST_NO_SPELLS, CE_NOXIOUS, S_HISS,
    I_ANIMAL, HT_LAND, 13, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_SNAKE,
    {TILEP_MONS_VIPER}, TILE_CORPSE_VIPER
},
...
// lightred was left and if they can't be WHITE and neutral in console
{
    ...
    M_FIGHTER | M_SPEAKS | M_INSUBSTANTIAL | M_NO_POLY_TO | M_FLIES | M_GHOST_DEMON | M_SEE_INVIS,
    MR_NO_FLAGS,
...
{
    MONS_TRICERATOPS, 'Y', RED, "the Triceratops",
...

{
    ...
    I_HUMAN, HT_AMPHIBIOUS_LAVA, 10, SWIM_ENERGY(7),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_NAGA,
	{TILEP_MONS_SALAMANDER_FIREBRAND}, TILE_ERROR
},
...
// animated armour - variable traits
{
    ...
    M_NO_FLAGS,
    MR_NO_FLAGS,
    10, MONS_ANIMATED_ARMOUR, MONS_ANIMATED_ARMOUR, MH_NONLIVING, MAG_IMMUNE,
...
{
    MONS_ROT_DEVIL, '4', GREEN, "rot devil",
    M_NO_FLAGS,
    MR_RES_POISON | MR_RES_COLD,
    10, MONS_ROT_DEVIL, MONS_ROT_DEVIL, MH_DEMONIC, 45,
    { {AT_HIT, AF_ROT, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 330,
    2, 10, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_ROT_DEVIL}, TILE_ERROR
},
...

{
    ...
    10, MONS_GOLEM, MONS_CLAY_GOLEM, MH_NONLIVING, MAG_IMMUNE,
    { {AT_HIT, AF_PLAIN, 25}, {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK },
    8, 1000,
    7, 5, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_BRAINLESS, HT_LAND, 8, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_HUMANOID,
    {TILEP_MONS_CLAY_GOLEM}, TILE_ERROR
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 35}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 1350,
    15, 3, MST_NO_SPELLS, CE_NOCORPSE, S_SQUEAK,
    I_BRAINLESS, HT_LAND, 7, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_HUMANOID,
...
{
    MONS_ANGHARAD, 'd', ETC_MAGIC, "Angharad",
    M_UNIQUE | M_SEE_INVIS| M_SPEAKS | M_FEMALE | M_FLIES,
    MR_RES_COLD | MR_RES_FIRE | MR_RES_ELEC,
    10, MONS_FAERIE_DRAGON, MONS_FAERIE_DRAGON, MH_NATURAL, 120,
    { {AT_HIT, AF_PLAIN, 24}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    22, 2250,
    // Also gets 6 SH in monster.cc like any FD
    8, 15, MST_ANGHARAD, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_SMALL, MON_SHAPE_HUMANOID,
    {TILEP_MONS_ANGHARAD}, TILE_CORPSE_FAERIE_DRAGON
},
