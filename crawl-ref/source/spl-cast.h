...
{
    none                 = 0x000000,
    dir_or_target        = 0x000001,      // use DIR_NONE targeting
    target               = 0x000002,      // use DIR_TARGET targeting
                                //0x000004,
    dir                  = 0x000008,      // use DIR_DIR targeting
    ...
    obj                  = 0x000010,      // TARG_MOVABLE_OBJECT used
    helpful              = 0x000020,      // TARG_FRIEND used
    neutral              = 0x000040,      // TARG_ANY used
    not_self             = 0x000080,      // aborts on isMe
    unholy               = 0x000100,      // counts as "unholy"
    unclean              = 0x000200,      // counts as "unclean"
    chaotic              = 0x000400,      // counts as "chaotic"
    hasty                = 0x000800,      // counts as "hasty"
    emergency            = 0x001000,      // monsters use in emergencies
    ...
    noisy                = 0x100000,      // makes noise, even if innate
    testing              = 0x200000,      // a testing/debugging spell
    corpse_violating     = 0x400000,      // Conduct violation for Fedhas
                        // 0x800000,      // was spflag::allow_self
    utility             = 0x1000000,      // usable no matter what foe is
    no_ghost            = 0x2000000,      // ghosts can't get this spell
    cloud               = 0x4000000,      // makes a cloud
    mr_check            = 0x8000000,      // spell that checks monster MR
...
int failure_check(spell_type spell, bool perma, bool justcheck = false);
