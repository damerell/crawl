...
{ // Lair (OOD cap: 12)
  ...
  {  3,  6,   25, SEMI, MONS_BUMBLEBEE },
  {  3,  6,   89, RISE, MONS_BOULDER_BEETLE },
  {  3,  6,   25, SEMI, MONS_BRAIN_WORM },
...
{ // Dis
  ...
  {  1,  7,  135, SEMI, MONS_FLAMING_CORPSE },
...
{ // Gehenna
  ...
  {  2,  6,   30, FLAT, MONS_EFREET },
  {  1,  7,  200, FLAT, MONS_FLAMING_CORPSE },
...
{ // Abyss
  ...
  {  1,  5,   25, FALL, MONS_ROT_DEVIL },
  {  1,  5,   25, FALL, MONS_ICE_DEVIL },
  {  1,  5,   11, FALL, MONS_RUST_DEVIL },
...
{ // Pandemonium - only used for 1 in 40 random Pan spawns (the rest are drawn
  ...
  {  1,  1,  335, FLAT, MONS_RED_DEVIL },
  {  1,  1,  335, FLAT, MONS_ROT_DEVIL },
...
{ // Swamp water monsters
  {  1,  4,   500, FLAT, MONS_SWAMP_WORM },
  {  1,  4,  1000, FLAT, MONS_NO_MONSTER },
  {  2,  4,   165, SEMI, MONS_THORN_LOTUS },
  { 0,0,0,FLAT,MONS_0 }
};
