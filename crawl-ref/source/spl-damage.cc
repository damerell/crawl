                                    ...
                                    bool actual)
{
    ...
    hurted = check_your_resists(hurted, beam.flavour, beam.name, agent, 0,
...
spret cast_discharge(int pow, const actor &agent, bool fail)
{
                              ...
                              bool &hole)
{
    ...
    else if (mon && (caster->is_monster() || (you.can_see(*mon))))
    {
        ...
        case MONS_CLAY_GOLEM:
            beam.name       = "blast of pottery shards";
            beam.colour     = BROWN;
            beam.damage.num = 4;
            break;
                              ...
                              const coord_def target, bool fail)
{
    ...
    else // Monster explodes.
    {
        ...
        if (caster->is_player())
            _player_hurt_monster(*mon, beam.damage.roll(), BEAM_MINDBURST);
        else
            mon->hurt(caster, beam.damage.roll(), BEAM_MINDBURST);
    }
