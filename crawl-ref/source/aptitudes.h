...
static const species_skill_aptitude species_skill_aptitudes[] =
{
    ...
    APT(SP_DEMIGOD,         SK_SHORT_BLADES,    0),
    APT(SP_DEMIGOD,         SK_LONG_BLADES,     0),
    APT(SP_DEMIGOD,         SK_AXES,            0),
    APT(SP_DEMIGOD,         SK_MACES_FLAILS,    0),
    APT(SP_DEMIGOD,         SK_POLEARMS,        0),
    APT(SP_DEMIGOD,         SK_STAVES,          0),
    APT(SP_DEMIGOD,         SK_SLINGS,          0),
    APT(SP_DEMIGOD,         SK_BOWS,            0),
    APT(SP_DEMIGOD,         SK_CROSSBOWS,       0),
    APT(SP_DEMIGOD,         SK_THROWING,        0),
    APT(SP_DEMIGOD,         SK_ARMOUR,          0),
    APT(SP_DEMIGOD,         SK_DODGING,         0),
    APT(SP_DEMIGOD,         SK_STEALTH,         0),
#if TAG_MAJOR_VERSION == 34
    APT(SP_DEMIGOD,         SK_STABBING,      UNUSABLE_SKILL),
#endif
    APT(SP_DEMIGOD,         SK_SHIELDS,         0),
#if TAG_MAJOR_VERSION == 34
    APT(SP_DEMIGOD,         SK_TRAPS,         UNUSABLE_SKILL),
#endif
    APT(SP_DEMIGOD,         SK_UNARMED_COMBAT,  0),
    APT(SP_DEMIGOD,         SK_SPELLCASTING,    1),
    APT(SP_DEMIGOD,         SK_CONJURATIONS,    0),
    APT(SP_DEMIGOD,         SK_HEXES,           0),
    APT(SP_DEMIGOD,         SK_CHARMS,          0),
    APT(SP_DEMIGOD,         SK_SUMMONINGS,      0),
    APT(SP_DEMIGOD,         SK_NECROMANCY,      0),
    APT(SP_DEMIGOD,         SK_TRANSLOCATIONS,  0),
    APT(SP_DEMIGOD,         SK_TRANSMUTATIONS,  0),
    APT(SP_DEMIGOD,         SK_FIRE_MAGIC,      0),
    APT(SP_DEMIGOD,         SK_ICE_MAGIC,       0),
    APT(SP_DEMIGOD,         SK_AIR_MAGIC,       0),
    APT(SP_DEMIGOD,         SK_EARTH_MAGIC,     0),
    APT(SP_DEMIGOD,         SK_POISON_MAGIC,    0),
    APT(SP_DEMIGOD,         SK_INVOCATIONS,     1),
