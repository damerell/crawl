...
const char* armour_ego_name(const item_def& item, bool terse)
{
    if (!terse)
    {
        ...
        case SPARM_WARDING:           return "warding";
    ...
    else
    {
        ...
        case SPARM_ARCHERY:           return "archery";
        case SPARM_REPULSION:         return "RMsl";
        case SPARM_CLOUD_IMMUNE:      return "CldImm";
        case SPARM_WARDING:           return "Ward rN+ MR+";
...
static const char* _wand_type_name(int wandtype)
{
    ...
    case WAND_CHARMING:     return "charm monster";
...
const char* jewellery_effect_name(int jeweltype, bool terse)
{
    ...
    else
    {
        ...
        case RING_LOUDNESS:              return "Noise+";
...
bool is_useless_item(const item_def &item, bool temp)
{
    ...
    case OBJ_JEWELLERY:
        ...
        case AMU_THE_GOURMAND:
            return you.get_mutation_level(MUT_HERBIVOROUS) == 3
