...
const vector<god_power> god_powers[NUM_GODS] =
{
    ...
    { { 1, ABIL_ZIN_RECITE, "recite Zin's Axioms of Law" },
      ...
      { 3, "Zin will now cleanse your body of mutations.",
        "Zin will no longer cleanse your body of mutations.",
        "Zin cleanses your body of mutations." },
      { 3, ABIL_ZIN_IMPRISON, "call upon Zin to imprison the lawless" },
      { 5, ABIL_ZIN_SANCTUARY, "call upon Zin to create a sanctuary" },
      { 6, "You can now preach from the Axioms of Law more frequently.",
        "You can no longer preach from the Axioms of Law as frequently.",
        "You can preach from the Axioms of Law more frequently." },
    ...
    { { 0, "perform damaging attacks by moving towards foes",
      ...
      { 1, "lightly attack monsters in place by moving around them",
           "perform spinning attacks" },
      { 1, "If martially attacking two or more foes, foes hit briefly lose accuracy.",
        "make enemies less accurate when you use martial attacks"},
      ...
      { 3, "pin monsters in place when making spinning attacks with Serpent's Lash", "pin monsters with Serpent's Lash" },
...
static monster_type _yred_servants[] =
{
    ...
    MONS_VAMPIRE, MONS_ROTTING_HULK, MONS_FLAMING_CORPSE, 
    MONS_PHANTASMAL_WARRIOR, 
    MONS_SKELETAL_WARRIOR, MONS_FLAYED_GHOST, MONS_VAMPIRE_KNIGHT, 
