...
const vector<GameOption*> game_options::build_options_list()
{
    ...
    vector<GameOption*> options = {
        ...
        new BoolGameOption(SIMPLE_NAME(easy_eat_chunks), true),
        ...
        new BoolGameOption(SIMPLE_NAME(dog_names), true),
...
void game_options::set_default_activity_interrupts()
{
    const char *default_activity_interrupts[] =
    {
        ...
        "interrupt_rest = interrupt_run, full_hp, full_mp, pb_miscast, ancestor_hp", 
...
game_options::game_options()
    : seed(0), no_save(false), no_player_bones(false), language(lang_t::EN),
    lang_name(nullptr)
{
    reset_options();
}
...
static const map<string, flang_t> fake_lang_names = {
    ...
    { "notoonolodoy", flang_t::notoonolodoy },
    { "hippo", flang_t::hippo },
